...
- sister-packages instructions: `sister_packages/AGENTS.md`
...
- **Developer** (`.github/agents/developer.md`): Code implementation, bugfixes, tests, Snakemake rules, refactoring
